...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# This script: run the cox model for gi_bleeds
...
library(optparse)
option_list <- list(
  make_option("--df_input", type = "character", default = "model_input-cohort_vax-main-upper_gi_bleeding.rds",
  ...
  make_option("--outcome", type = "character", default = "out_date",
  ...
  make_option("--covariate_other", type = "character",
              ...
              metavar = "varname_1;varname_2;..."),
  make_option("--cox_start", type = "character", default = "index_date",
              ...
              metavar = "varname_1;varname_2;..."),
  make_option("--cox_stop", type = "character", default = "death_date;end_date_outcome;out_date",
...
source("analysis/cox_model_gi_bleeds/fn-survival_data_setup.R")
source("analysis/cox_model_gi_bleeds/fn-get_episode_info_gi_bleeds.R")
source("analysis/cox_model_gi_bleeds/fn-check_covariates_gi_bleeds.R")
source("analysis/cox_model_gi_bleeds/fn-fit_model_gi_bleeds.R")
...
print(summary(data_surv))
  ...
  if (opt$run_analysis == TRUE)  {
    ...
    results$cox_ipw <- "v0.0.27"  # Do we need a new version?
