...
## Combined oral contraceptive pill
    ...
    tmp_cov_num_cholesterol=patients.max_recorded_value(
        ...
        return_expectations={
            ...
            "date": {"earliest":study_dates["earliest_expec"], "latest": study_dates["omicron_date"]}, ##return_expectations can't take dynamic variable se default are kept here! 
            "incidence": 0.80,
        },
    ),
    ...
    tmp_cov_num_hdl_cholesterol=patients.max_recorded_value(
        ...
        return_expectations={
            ...
            "date": {"earliest": study_dates["earliest_expec"] , "latest": study_dates["omicron_date"]},
            "incidence": 0.80,
        },
    ),
