...
# df <- arrow::read_feather(file = "output/index_dates.feather",
...
#                                            "cov_cat_sex",
#                                            "vax_date_eligible",
#                                            "vax_cat_jcvi_group","cov_num_consulation_rate",
#                                            "cov_bin_healthcare_worker",
#                                            "qa_bin_prostate_cancer",
#                                            "qa_bin_pregnancy",
#                                            "qa_num_birth_year",
...
# df <- merge(tmp1,tmp2 by = "patient_id")
# rm(tmp1,tmp2)
...
#                 
#                 contains("qa_"),
#                 contains("vax_date_eligible"), 
#                 contains("vax_date_covid_"),
#                 contains("vax_cat_"), 
#                 contains("cov_"),
#                 everything()
#                 
