...
print (s)
abdominal_distension_snomed = codelist_from_csv('codelists/bristol-abdominal-distension-snomed.csv' , system = 'snomed' , column = 'code' )abdominal_distension_icd10 = codelist_from_csv('codelists/bristol-abdominal-distension-icd10.csv' , system = 'icd10' , column = 'code' )
...
diarrhoea_icd_10 = codelist_from_csv('codelists/bristol-diarrhoea-icd-10.csv' , system = 'icd10' , column = 'code' )
...
nausea_icd_10 = codelist_from_csv('codelists/bristol-nausea-icd-10.csv' , system = 'icd10' , column = 'code' )
...
vomititing_icd_10 = codelist_from_csv('codelists/bristol-vomititing-icd-10.csv' , system = 'icd10' , column = 'code' )
...
gallstone_disease_icd10 = codelist_from_csv('codelists/bristol-gallstone-disease-icd10.csv' , system = 'icd10' , column = 'code' )
...
dyspesia_icd10 = codelist_from_csv('codelists/bristol-dyspesia-icd10.csv' , system = 'icd10' , column = 'code' )
...
history_of_stomach_and_duodenum_diseases_snomed = codelist_from_csv('codelists/bristol-history-of-stomach-and-duodenum-diseases-snomed.csv' , system = 'snomed' , column = 'code' )history_of_small_bowel_and_colon_diseases_snomed = codelist_from_csv('codelists/bristol-history-of-small-bowel-and-colon-diseases-snomed.csv' , system = 'snomed' , column = 'code' )
